...
string apiToken = configuration["TelegramBot:ApiToken"];
string dbConnection = configuration["DB:ConnectionString"];

//var medicineDiary = new MedicineDiary_logic.MedicineDiary(dbConnection);

using CancellationTokenSource cts = new();
var bot = new TelegramBotClient(apiToken, cancellationToken: cts.Token);
